        ...
        <div class="card border border-light-subtle rounded-3 shadow-sm mt-5">
          <div class="card-body p-3 p-md-4 p-xl-5">
            <div class="text-center mb-3">
              <a href="#!">
                <!-- <img src="<?php echo e('theme/img/logo.png'); ?>" alt="QDegrees Logo" width="250"> -->
              </a>
            </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-12">
                  <p class="m-0 text-secondary text-center">Don't have an account? <a href="<?php echo e(route('register')); ?>" class="link-primary text-decoration-none">Sign up</a></p>
                </div>
              </div>
            </form>
          </div>
...
<?php echo $__env->make('auth.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\my_Projects\student-management\resources\views/auth/login.blade.php ENDPATH**/ ?>