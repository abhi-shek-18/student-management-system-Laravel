...
<?php $__env->startSection('content'); ?>
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="<?php echo e(url('/courses/create')); ?>" class="btn btn-success btn-sm" title="Add New Teacher">
                            ...
                            <table class="table">
                                ...
                                <?php $__currentLoopData = $course; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo e(url('/courses/' . $item->id)); ?>" title="View Course"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\my_Projects\student-management\resources\views/courses/index.blade.php ENDPATH**/ ?>